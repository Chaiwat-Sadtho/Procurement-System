...
const pr: PurchaseRequest = {
  id: 1, prNumber: 'PR-2026-0001', title: 'Laptop', status: 'submitted',
  totalEstimatedAmount: 5000, quarter: null, requiredDate: '2026-02-01', requesterId: 1,
...
function renderTable() {
  return render(<MemoryRouter><RecentPRsTable /></MemoryRouter>)
}
...
describe('RecentPRsTable', () => {
  ...
  it('shows loading skeleton', () => {
    vi.mocked(useRecentPRs).mockReturnValue({ data: undefined, isLoading: true } as ReturnType<typeof useRecentPRs>)
    renderTable()
