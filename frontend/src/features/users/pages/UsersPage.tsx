...
export function UsersPage() {
  ...
  const [appliedFilters, setAppliedFilters] = useState<UserFilterValues>(DEFAULT_USER_FILTERS)
  ...
  const rows = users ? filterUsers(users, appliedFilters) : []

  const handleSubmit = (values: UserFilterValues) => {
  ...
  return (
    <div>
      ...
      <UserListFilterForm onSubmit={handleSubmit} onClear={handleClear} canClear={hasSearched} />
